...
class DecryptionTest < Minitest::Test
  ...
  def test_we_can_give_it_text_rotation_and_offset
    decryptnomicon = Decryption.new("z6o360cb6gov", "96348", 280317)
    assert_equal "z6o360cb6gov", decryptnomicon.text
  ...
  def test_it_can_parse_rotation_to_an_array
    decryptnomicon = Decryption.new("z6o360cb6gov", "96348", 280317)
    assert_equal [65, 56, 63, 30], decryptnomicon.unrotate
  end
  ...
  def test_it_can_create_a_key
    decryptnomicon = Decryption.new("z6o360cb6gov", "96348", 280317)
    assert_equal [-65, -60, -71, -39], decryptnomicon.create_key
  end
  ...
  def test_it_zips_a_message
    ...
    assert_instance_of String, decryptnomicon.text[0][0]
    assert_instance_of Fixnum, decryptnomicon.text[0][1]
  end
